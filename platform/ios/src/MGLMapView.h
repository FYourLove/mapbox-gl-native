...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/simple-map-view/">Simple map view</a> example to learn how to initialize a basic `MGLMapView`.
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/custom-style/">Apply a style designed in Mapbox Studio</a> example to learn how to initialize an `MGLMapView` with a custom style. See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/raster-styles/">Appy a style designed in Mapbox Studio Classic</a> example to learn how to intialize an `MGLMapView` with a Studio Classic style _or_ a custom style JSON. See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/source-custom-vector/">Use third-party vector tiles</a> example to learn how to initialize an `MGLMapView` with a third-party tile source.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/switch-styles/">Switch between map styles</a> example to learn how to change the style of a map at runtime.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/user-location-annotation/">Customize the user location annotation</a> to learn how to customize the deafult user location annotation shown by `MGLUserTrackingMode`.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/camera-animation/">Camera animation</a> example to learn how to trigger an animation that rotates around a central point.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/camera-animation/">Camera animation</a> example to learn how to create a timed animation that rotates around a central point for a specific duration.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/point-conversion/">Point conversion</a> example to learn how to convert a `GCPoint` to a map coordinate.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/point-conversion/">Point conversion</a> example to learn how to convert a map coordinate to a `GCPoint` object.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/annotation-models/">Annotation models</a> and <a href="https://www.mapbox.com/ios-sdk/maps/examples/line-geojson/">Add a line annotation from GeoJSON</a> examples to learn how to add an annotation to an `MGLMapView` object.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/annotation-view-image/">Add annotation views and images</a> example learn how to most efficiently reuse an `MGLAnnotationImage`.
 */
...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/select-layer/">Select a feature within a layer</a> example to learn how to query an `MGLMapView` object for visible `MGLFeature` objects.
 */
