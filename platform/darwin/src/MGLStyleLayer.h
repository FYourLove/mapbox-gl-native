...
/**
 ...
 #### Related examples
 See the <a href="https://www.mapbox.com/ios-sdk/maps/examples/runtime-toggle-layer/">Show and hide a layer</a> example to learn how to toggle an `MGLStyleLayer` object's visiblity.
 */
